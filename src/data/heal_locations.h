static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 14, 25},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 6, 25},
    ...
    [HEAL_LOCATION_RADIA_VILLAGE - 1] = {MAP_GROUP(RADIA_VILLAGE), MAP_NUM(RADIA_VILLAGE), 6, 25},
    [HEAL_LOCATION_MORNING_ISLAND - 1] = {MAP_GROUP(MORNING_ISLAND), MAP_NUM(MORNING_ISLAND), 10, 10},
};
