...
const struct Tileset gTileset_Arid_Terrain =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Arid_Terrain,
    .palettes = gTilesetPalettes_Arid_Terrain,
    .metatiles = gMetatiles_Arid_Terrain,
    .metatileAttributes = gMetatileAttributes_Arid_Terrain,
    .callback = NULL,
};

const struct Tileset gTileset_Arid_Town =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Arid_Town,
    .palettes = gTilesetPalettes_Arid_Town,
    .metatiles = gMetatiles_Arid_Town,
    .metatileAttributes = gMetatileAttributes_Arid_Town,
    .callback = NULL,
};

const struct Tileset gTileset_Grassy_Terrain =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Grassy_Terrain,
    .palettes = gTilesetPalettes_Grassy_Terrain,
    .metatiles = gMetatiles_Grassy_Terrain,
    .metatileAttributes = gMetatileAttributes_Grassy_Terrain,
    .callback = NULL,
};

const struct Tileset gTileset_BasicBuilding =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_BasicBuilding,
    .palettes = gTilesetPalettes_BasicBuilding,
    .metatiles = gMetatiles_BasicBuilding,
    .metatileAttributes = gMetatileAttributes_BasicBuilding,
    .callback = NULL,
};
...
const struct Tileset gTileset_Morning_Island =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Morning_Island,
    .palettes = gTilesetPalettes_Morning_Island,
    .metatiles = gMetatiles_Morning_Island,
    .metatileAttributes = gMetatileAttributes_Morning_Island,
    .callback = NULL,
};

const struct Tileset gTileset_Morning_Interior =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Morning_Interior,
    .palettes = gTilesetPalettes_Morning_Interior,
    .metatiles = gMetatiles_Morning_Interior,
    .metatileAttributes = gMetatileAttributes_Morning_Interior,
    .callback = NULL,
};
